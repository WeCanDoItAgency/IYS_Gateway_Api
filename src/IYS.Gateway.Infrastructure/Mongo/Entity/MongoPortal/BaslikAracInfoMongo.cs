...
/// <summary>
/// Araç başlık bilgi tanımları — MSSQL BaslikAracInfo entity'sinin MongoDB karşılığı.
/// FK: FirmId -> NewFirms, UserId/UpdatedUserId -> Kullanicilar, BaslikId + QueryType -> MONGO_53 (COMPOSITE).
/// </summary>
[BsonCollection("BaslikAracInfo")]
[BsonIgnoreExtraElements]
public class BaslikAracInfoMongo : MongoDbEntity
{
    ...
    /// <summary>LOCAL FK → NewFirms</summary>
    public ObjectId? FirmMongoId { get; set; }

    /// <summary>LOCAL FK → Kullanicilar</summary>
    public ObjectId? UserMongoId { get; set; }

    /// <summary>LOCAL FK → Kullanicilar</summary>
    public ObjectId? UpdatedUserMongoId { get; set; }

    /// <summary>COMPOSITE FK → HeadersMongo (MONGO_53/Offers)</summary>
