...
public partial class ImmDetaylar
{
    ...
    public virtual ImmBasliklar Baslik { get; set; } = null!;

    public virtual ICollection<ImmPoliceler> ImmPoliceler { get; set; } = new List<ImmPoliceler>();
}
