...
public partial class HemsireDetaylar
{
    ...
    public virtual HemsireBasliklar? Baslik { get; set; }

    public virtual ICollection<HemsirePoliceler> HemsirePoliceler { get; set; } = new List<HemsirePoliceler>();
}
