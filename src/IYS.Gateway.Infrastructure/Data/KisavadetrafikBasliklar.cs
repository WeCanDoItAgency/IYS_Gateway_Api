...
public partial class KisavadetrafikBasliklar
{
    ...
    public virtual ICollection<KisavadetrafikDetaylar> KisavadetrafikDetaylar { get; set; } = new List<KisavadetrafikDetaylar>();
