...
public partial class IncomingDetay
{
    ...
    public bool IsIrakProduct { get; set; }
    ...
    public double? BrutPrimTl { get; set; }

    public double? NetPrimTl { get; set; }
    ...
    public virtual IncomingBaslik Baslik { get; set; } = null!;

    public virtual ICollection<IncPoliceler> IncPoliceler { get; set; } = new List<IncPoliceler>();
}
