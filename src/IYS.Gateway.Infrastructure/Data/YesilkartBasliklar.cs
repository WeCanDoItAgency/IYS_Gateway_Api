...
public partial class YesilkartBasliklar
{
    ...
    public byte? ImmTeminat { get; set; }

    public bool? IsRentaCar { get; set; }

    public string? CrossSellingStartQueryType { get; set; }

    public int? DestinationCountry { get; set; }

    public int? GeographicArea { get; set; }
    ...
    public virtual ICollection<YesilkartDetaylar> YesilkartDetaylar { get; set; } = new List<YesilkartDetaylar>();
}
