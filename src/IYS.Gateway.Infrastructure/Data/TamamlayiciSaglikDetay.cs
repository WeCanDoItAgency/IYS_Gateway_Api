...
public partial class TamamlayiciSaglikDetay
{
    ...
    public virtual TamamlayiciSaglikBaslik Baslik { get; set; } = null!;

    public virtual ICollection<TamamlayiciSaglikPolice> TamamlayiciSaglikPolice { get; set; } = new List<TamamlayiciSaglikPolice>();
}
