...
public partial class PetSaglikBasliklar
{
    ...
    public int? HayvanIrki { get; set; }

    public string? Cinsiyet { get; set; }

    public bool? Cipvarmi { get; set; }
    ...
    public virtual ICollection<PetSaglikDetaylar> PetSaglikDetaylar { get; set; } = new List<PetSaglikDetaylar>();
}
