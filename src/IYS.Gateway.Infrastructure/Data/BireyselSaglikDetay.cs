...
public partial class BireyselSaglikDetay
{
    ...
    public virtual BireyselSaglikBaslik Baslik { get; set; } = null!;

    public virtual ICollection<BireyselSaglikPolice> BireyselSaglikPolice { get; set; } = new List<BireyselSaglikPolice>();
}
