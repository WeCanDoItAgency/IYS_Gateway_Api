...
public partial class ScheduledJobs2
{
    ...
    public string? PolicenoKasko { get; set; }

    public string? PolicenoTrafik { get; set; }

    public string? PolicenoDiger { get; set; }
    ...
    public string? PartajNoKasko { get; set; }

    public string? PartajNoTrafik { get; set; }

    public string? PartajNoDiger { get; set; }

    public DateTime? PolicyStartDateTrafik { get; set; }

    public DateTime? PolicyEndDateTrafik { get; set; }

    public DateTime? PolicyStartDateKasko { get; set; }

    public DateTime? PolicyEndDateKasko { get; set; }

    public DateTime? PolicyStartDateDiger { get; set; }

    public DateTime? PolicyEndDateDiger { get; set; }
