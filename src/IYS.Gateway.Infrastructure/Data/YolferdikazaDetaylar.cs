...
public partial class YolferdikazaDetaylar
{
    ...
    public virtual YolferdikazaBasliklar Baslik { get; set; } = null!;

    public virtual ICollection<YolferdikazaPoliceler> YolferdikazaPoliceler { get; set; } = new List<YolferdikazaPoliceler>();
}
