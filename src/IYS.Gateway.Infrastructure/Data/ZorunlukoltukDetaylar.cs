...
public partial class ZorunlukoltukDetaylar
{
    ...
    public virtual ZorunlukoltukBasliklar Baslik { get; set; } = null!;

    public virtual ICollection<ZorunlukoltukPoliceler> ZorunlukoltukPoliceler { get; set; } = new List<ZorunlukoltukPoliceler>();
}
