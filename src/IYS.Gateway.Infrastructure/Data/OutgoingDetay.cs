...
public partial class OutgoingDetay
{
    ...
    public virtual OutgoingBaslik Baslik { get; set; } = null!;

    public virtual ICollection<OutgPoliceler> OutgPoliceler { get; set; } = new List<OutgPoliceler>();
}
