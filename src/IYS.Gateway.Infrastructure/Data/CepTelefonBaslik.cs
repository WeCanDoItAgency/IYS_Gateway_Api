...
public partial class CepTelefonBaslik
{
    ...
    public int? TeminatTipi { get; set; }
    ...
    public virtual ICollection<CepTelefonDetay> CepTelefonDetay { get; set; } = new List<CepTelefonDetay>();
