...
public partial class NakliyatDetay
{
    ...
    public virtual NakliyatBaslik Baslik { get; set; } = null!;

    public virtual ICollection<NakliyatPoliceler> NakliyatPoliceler { get; set; } = new List<NakliyatPoliceler>();
}
