...
public partial class PetSaglikDetaylar
{
    ...
    public virtual PetSaglikBasliklar Baslik { get; set; } = null!;

    public virtual ICollection<PetSaglikPolice> PetSaglikPolice { get; set; } = new List<PetSaglikPolice>();
}
