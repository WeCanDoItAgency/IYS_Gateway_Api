...
public partial class DugunDetaylar
{
    ...
    public virtual DugunBasliklar Baslik { get; set; } = null!;

    public virtual ICollection<DugunPoliceler> DugunPoliceler { get; set; } = new List<DugunPoliceler>();
}
