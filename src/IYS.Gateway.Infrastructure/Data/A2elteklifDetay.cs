...
public partial class A2elteklifDetay
{
    ...
    public virtual ICollection<A2elPoliceler> A2elPoliceler { get; set; } = new List<A2elPoliceler>();

    public virtual A2elteklifBasliklar Baslik { get; set; } = null!;
}
