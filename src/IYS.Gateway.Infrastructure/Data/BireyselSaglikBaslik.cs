...
public partial class BireyselSaglikBaslik
{
    ...
    public string? MevcutAciklama { get; set; }

    public int AmerikanHastane { get; set; }

    public int ATipiHastane { get; set; }

    public int AyaktaTedavi { get; set; }

    public int AyaktaTedaviLimit { get; set; }

    public int Dogum { get; set; }

    public int DogumLimit { get; set; }

    public int YurtdisiTedavi { get; set; }
    ...
    public virtual ICollection<BireyselSaglikDetay> BireyselSaglikDetay { get; set; } = new List<BireyselSaglikDetay>();
