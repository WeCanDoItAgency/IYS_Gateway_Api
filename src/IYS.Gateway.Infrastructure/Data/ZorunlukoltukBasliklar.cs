...
public partial class ZorunlukoltukBasliklar
{
    ...
    public virtual ICollection<ZorunlukoltukDetaylar> ZorunlukoltukDetaylar { get; set; } = new List<ZorunlukoltukDetaylar>();
}
