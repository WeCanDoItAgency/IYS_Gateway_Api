...
public partial class KonutDetaylar
{
    ...
    public virtual KonutBasliklar? Baslik { get; set; }

    public virtual ICollection<KonutPoliceler> KonutPoliceler { get; set; } = new List<KonutPoliceler>();
}
