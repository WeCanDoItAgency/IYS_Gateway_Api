...
public partial class DaskDetay
{
    ...
    public virtual DaskBasliklar? Baslik { get; set; }

    public virtual ICollection<DsPoliceler> DsPoliceler { get; set; } = new List<DsPoliceler>();
}
