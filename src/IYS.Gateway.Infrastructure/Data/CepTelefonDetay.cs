...
public partial class CepTelefonDetay
{
    ...
    public virtual CepTelefonBaslik Baslik { get; set; } = null!;

    public virtual ICollection<CepTelefonPolice> CepTelefonPolice { get; set; } = new List<CepTelefonPolice>();
}
