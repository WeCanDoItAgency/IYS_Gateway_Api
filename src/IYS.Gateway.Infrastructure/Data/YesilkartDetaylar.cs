...
public partial class YesilkartDetaylar
{
    ...
    public virtual YesilkartBasliklar Baslik { get; set; } = null!;

    public virtual ICollection<YesilkartPoliceler> YesilkartPoliceler { get; set; } = new List<YesilkartPoliceler>();
}
