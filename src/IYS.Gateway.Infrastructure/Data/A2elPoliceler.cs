...
public partial class A2elPoliceler
{
    ...
    public string? IncomingFileCert { get; set; }

    public string? OutgoingFileCert { get; set; }
    ...
    public virtual A2elteklifDetay Detay { get; set; } = null!;
