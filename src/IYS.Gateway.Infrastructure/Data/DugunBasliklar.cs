...
public partial class DugunBasliklar
{
    ...
    public string? GelinSoyadi { get; set; }

    public string GelinTcvknNo { get; set; } = null!;

    public string? GelinPasaportno { get; set; }

    public string? GelinMobilephone { get; set; }

    public DateTime? GelinBirthdate { get; set; }

    public string? DamatAdi { get; set; }

    public string? DamatSoyadi { get; set; }

    public string DamatTcvknNo { get; set; } = null!;

    public string? DamatPasaportno { get; set; }

    public string? DamatMobilephone { get; set; }

    public DateTime? DamatBirthdate { get; set; }

    public int? SigortaEttirenKisi { get; set; }

    public string? SigortaEttirenAdi { get; set; }

    public string? SigortaEttirenSoyadi { get; set; }

    public string SigortaEttirenTcvknNo { get; set; } = null!;

    public string? SigortaEttirenPasaportno { get; set; }

    public string? SigortaEttirenMobilephone { get; set; }

    public DateTime? SigortaEttirenBirthdate { get; set; }

    public string? DugunSalonuAdi { get; set; }
    ...
    public virtual ICollection<DugunDetaylar> DugunDetaylar { get; set; } = new List<DugunDetaylar>();
