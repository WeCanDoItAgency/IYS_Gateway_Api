...
public partial class FerdikazateklifDetay
{
    ...
    public virtual FerdikazateklifBasliklar Baslik { get; set; } = null!;

    public virtual ICollection<FerdikazaPoliceler> FerdikazaPoliceler { get; set; } = new List<FerdikazaPoliceler>();
}
